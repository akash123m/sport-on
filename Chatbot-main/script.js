...
const getChatResponse = async (inChatDiv) => {
  ...
  const requestOptions = {
    ...
    body: JSON.stringify({
      prompt: {
        context: "You should act like doctor, I will provide you what I am suffering from and you should answer in advisory manner what should I do to be healthy  ,answer in  minimum words as possible as it should be easy for user to understand",
        examples: [],
        messages: [
          {
            content: UserText,
